...
class Scene:
    ...
    def load(self):
        ...
        self.tank = Tank(app, offset=(-.3, -15, 0), pos = (.25, 0, 0), rot=(-90,178,0), scale=(2, 2, 2))
        add(self.tank)
        ...
        add(Container(app, offset=(0, 0, 0), rot=(-90,0,0), scale=(.03, .03, .03), pos=(60,0,-75)))
        add(Building1(app, offset=(0, 0, 0), rot=(0,-90,0), scale=(.04, .04, .04), pos=(90,0,-50))) 
        add(Building2(app, offset=(0, 550, 0), rot=(0,90,0), scale=(.015, .015, .015), pos=(40,0,-40)))
