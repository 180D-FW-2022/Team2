...
class Cube:
    def __init__(self, app):
        ...
        self.texture = self.get_texture(path='textures/test_texture.png')
        self.on_init()
    ...
    def get_vertex_data(self):
        ...
        return vertex_data
    @staticmethod
    def get_data(vertices, indicies):
        data = [vertices[ind] for triangle in indicies for ind in triangle]
