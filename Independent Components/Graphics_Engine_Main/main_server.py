...
class GraphicsEngine:
    def __init__(self, win_size=(1280, 720)):
        ...
        if USE_DEFAULT_SETTINGS:
            ...
            if FIRST_POV:
                ...
                self.camera = Camera(self, position=(0, 5, 0), pitch=-90)
            else:
    ...
    def run_no_camera(self):
        ...
        while True:
            ...
            if USE_SKY_BOX:
                ...
                self.render(background, bullet=bullet, target=targets)
    ...
    def run_with_camera(self):
        ...
        homography = calibrate_arena(vid, debug=CALIBRATE_DEBUG)
        old_positions = None
        score = 0
        ...
        while True:
            ...
            if USE_MULTIPLAYER:
                data_string = json.dumps(positions)
