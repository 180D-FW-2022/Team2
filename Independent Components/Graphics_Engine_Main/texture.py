...
class Texture:
    def __init__(self, app):
        ...
        self.textures['grid'] = self.get_texture(path='textures/final_arena_texture.png')
        self.textures['test'] = self.get_texture(path='textures/test.png')
        self.textures['camera_shape'] = self.get_texture(path='textures/camera_shape.png')

        self.textures['tank'] = self.get_texture(path='PROPS/Tank/skin1.jpg')
        self.textures['container'] = self.get_texture(path='PROPS/Container/container.jpg')
        self.textures['building1'] = self.get_texture(path='PROPS/Building1/building.jpg')
        self.textures['building2'] = self.get_texture(path='PROPS/Building2/building.png')
